...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'webjtgpos@gmail.com',
            'smtp_pass' => 'Webjtgpos128',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('webjtgpos@gmail.com', 'WEB Jateng Pos');
    ...
    public function changePassword()
    {
        ...
        $this->form_validation->set_rules('password2', 'RepeatPassword', 'trim|required|min_length[3]|matches[password1]');
